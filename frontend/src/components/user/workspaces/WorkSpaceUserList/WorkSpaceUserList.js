...
//               : ""
//           } w-full text-start flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-white rounded-lg hover:bg-gray-400 `}
...
//                 <button
//                   type="button"
//                   className={`hs-accordion-toggle mt-1 hs-accordion-active:text-blue-600 hs-accordion-active:hover:bg-transparent w-full text-start flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-white rounded-lg hover:bg-gray-400 ${ selectedUser === member.user.id ? "bg-gray-400" : "text-white"}`}
...
const WorkSpaceUserList = () => {
  ...
  const workspaceID = useSelector((state) => state.workspace.workspaceId);
  const authenticated_user = useSelector((state) => state.authenticationUser);
  const authenticated_user_id = authenticated_user ? authenticated_user.id : null;
  ...
  const filteredUsers = menuItems.filter(user =>
        ...
        >
          ...
          >
            {filteredUsers.length === 0 ? (
              <li className="text-center text-red-400 mt-4">No users found</li>
            ) : (
