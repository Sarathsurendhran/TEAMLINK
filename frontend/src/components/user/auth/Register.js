...
const Register = ()=>{
  ...
  const validate = (e)=>{
    ...
    if (!usernameRegex.test(username)) {
      toast.warning("Invalid Username Format, Username should only contain alphanumeric characters");
      return false;
    }
            ...
            <form onSubmit={hadleSubmit}>
              <div className="mx-auto max-w-sm">
                ...
                <input  
                  ...
                  />
                <button type="submit" className="mt-5 tracking-wide font-semibold bg-[#7157FE] text-gray-100 w-full py-4 rounded-lg hover:bg-indigo-700 transition-all duration-300 ease-in-out flex items-center justify-center focus:shadow-outline focus:outline-none">
                  <svg
